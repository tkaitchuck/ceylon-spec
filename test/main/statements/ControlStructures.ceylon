class ControlStructures() {
    ...
    mutable class TryBlocks() { 
        ...
        catch (@type:"ControlStructures.TryBlocks.Exception1|ControlStructures.TryBlocks.Exception2" Exception1|Exception2 e) {
            @type:"String" value msg = e.message;
            @type:"Null|Throwable" value cause = e.cause;
        }
        ...
        try {}
        catch (@type:"ControlStructures.TryBlocks.Exception1" Exception1 e1) {}
